...
from patients.forms import PatientUserForm, PatientForm, AppointmentForm
...
def admin_add_doctor_view(request):
    ...
    if request.method == 'POST':
        ...
        if userForm.is_valid() and doctorForm.is_valid():
            ...
            my_doctor_group = models.Group.objects.get_or_create(name='DOCTOR')
...
def admin_add_patient_view(request):
    ...
    if request.method == 'POST':
        ...
        if userForm.is_valid() and patientForm.is_valid():
            ...
            my_patient_group = models.Group.objects.get_or_create(name='PATIENT')
...
def download_pdf_view(request, pk):
    ...
    return render_to_pdf('hospital/download_bill.html', data)
